         ...
         <div class="row">
            <div class="col-md-6 offset-md-3">
               <div class="card">
                  ...
                  <div class="card-body">
                     {!! Form::open( array('route' => 'book.update','class'=>'form-horizontal needs-validation','novalidate', 'id'=>"studentForm", 'enctype' => "multipart/form-data") ) !!}
                     <input type="hidden" name="id" value="{{$books->id}}"/>
                     <div class="form-group">
                        {!! Form::label('Book_name', "Book Name",array('class'=>'col-form-label')) !!}
                        {!! Form::text('Book_name', $books->Book_name, array('class'=>'form-control', 'required', 'maxlength' => 10, 'minlength' => 1, 'id' => 'Book_name','placeholder' => "Book Name"))!!}
                     </div>
                     <div>
